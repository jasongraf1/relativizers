...
### discard observations with animate antecendents (not subject to analysis 
### in the Language paper either)
### weed out "garbage" (i.e. observations with improbable values) 
### (most of the cases were extracted & annotated automatically by software)
...
#library(SnowballC)
#relativizers$prunedAntHead <- filter.infrequent(SnowballStemmer(relativizers$antntHead), 4)
#relativizers$prunedAntHead <- filter.infrequent(wordStem(relativizers$antHead), 4)
